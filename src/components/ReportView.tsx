      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          <Card className="h-full border-foreground/5 bg-white/40 dark:bg-foreground/[0.02] backdrop-blur-xl">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] opacity-40 font-bold">
        ...
        <div className="space-y-6">
          ...
          >
            <Card className="border-foreground/5 bg-white/40 dark:bg-foreground/[0.02] backdrop-blur-xl">
              ...
              <CardContent>
                <p className="text-sm leading-relaxed opacity-80 italic border-l-2 border-emerald-500/20 pl-4 py-1">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] uppercase tracking-widest opacity-40 font-bold">Potential Matches</span>
                      <span className="text-xl font-mono font-bold text-primary">{report.volunteerOptimization.volunteerMatchCount}</span>
                    </div>
                    <div className="space-y-2">
                      <p className="text-[9px] uppercase tracking-[0.2em] opacity-30 font-bold">Recommended NGOs</p>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="p-3 rounded-lg bg-primary/10 border border-primary/20">
                  ...
                  <p className="text-[11px] leading-relaxed opacity-80">{report.marketIntelligence?.demographicInsights}</p>
                </div>
                <div className="space-y-2">
                  <p className="text-[10px] uppercase tracking-widest font-bold opacity-30">Regional Trends</p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          <Card className="h-full border-none bg-[#020617] text-[#E4E3E0] shadow-2xl overflow-hidden relative">
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[10px] uppercase tracking-[0.3em] opacity-60 font-bold">
        ...
        >
          <Card className="h-full border-foreground/5 bg-white/40 dark:bg-foreground/[0.02] backdrop-blur-xl">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] opacity-40 font-bold outline-none">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={`sh-${sh.label}-${idx}`} className={`p-4 rounded-xl ${sh.bg} border ${sh.border} space-y-2`}>
                    ...
                    <p className="text-[11px] leading-relaxed opacity-80 italic">"{sh.view}"</p>
                  </div>
                ))}
              </div>
            </CardContent>
